...
def on_update_interval():
    ...
    obstacle = sprites.create(img("""
        ...
        """),
        SpriteKind.enemy)
    obstacle.set_velocity(0, 50)
    obstacle.set_position([lane1, lane2, lane3, lane4]._pick_random(), 0)
...
def on_update_interval3():
    ...
    enemyCar = sprites.create(img("""
        ...
        """),
        SpriteKind.enemy)
    enemyCar.set_velocity(0, 25)
    enemyCar.set_position([lane1, lane2, lane3, lane4]._pick_random(), 0)
